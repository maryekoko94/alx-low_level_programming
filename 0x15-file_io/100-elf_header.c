 ...
 *
 * Description: This function prints the ABI version of an ELF header.
 */
void print_abi(unsigned char *e_ident)
{
 ...
 * @e_ident: A pointer to an array containing the ELF class.
 *
 * Description: Prints the entry point address in the header.
 **/
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
 ...
 *
 * Description: Closes the file descriptor fd. If the file
 * cannot be closed, exits with error code 98.
 **/
